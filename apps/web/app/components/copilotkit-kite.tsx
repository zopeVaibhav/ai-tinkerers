/**
 * CopilotKit's kite mark, taken verbatim from the artwork that ships in
 * @copilotkit/web-inspector. Not redrawn — every path is as published; the only
 * changes are JSX attribute casing and gradient ids scoped so they cannot
 * collide with anything else on the page.
 */
export function CopilotKitKite() {
    return (
        <svg
