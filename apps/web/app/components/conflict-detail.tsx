...
import { EASE, fade, riseIn } from "../lib/motion";
...
export function ConflictDetail({
    ...
    return (
        /* Waiting rather than overlapping: two panels in the page grid at once
           would stack and shove the list, which is worse than the hard swap. */
        <AnimatePresence mode="wait">
            ...
            >
                <section className="flex flex-col gap-4 rounded-xl border border-neutral-200 bg-white p-5">
                    ...
                    {/* Fades only when a resolution actually lands; on a panel swap the
                        parent has already carried it in. */}
